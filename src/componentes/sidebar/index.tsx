...
import Logo from "../logo"; // ✅ importa seu logo em base64

const SideBar: React.FC = () => {   
  const [isOpen, setIsOpen] = useState(false);  // Inciar siderbar ocultado
  const handleToggle = () => {     
    setIsOpen(!isOpen);   
  };    
    ...
    <>       
      ...
      <div style={sidebarStyle}>         
        <div className="text-center mb-4">           
          <Logo /> {/* ✅ agora o logo é um componente reaproveitável */}
        </div>          
